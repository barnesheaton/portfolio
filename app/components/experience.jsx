...
const list = [
  ...
  },
  {
    ...
    bullets: [
      "✌️ Redesigned and rebuilt the entire website of a highly trafficked business, migrating from Wordpress to Webflow, with added use of Javascript, HTML, CSS, and JQuery for seamless user experiences.",
      ...
      "🤝 Built good relationships with my clients to navigate project goals, budgeting, deadlines, and delivery",
    ],
    tags: ["React", "JS", "HTML", "CSS"],
  },
  {
    ...
    bullets: [
      ...
      "🏙️ Developed, designed, tested, and fine-tuned a JavaScript/OpenGL animation for the primary interface of a nationwide kiosk, reaching an audience of over 10 million customers on a daily basis.",
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      "🎙️ Collaborated with Co-Founders to provide end-to-end delivery of projects, from planning, brainstorming, design, building, testing, and shipping, to measuring results and receiving internal stakeholder feedback on KPIs and Sprint planning tactics.",
    ],
